...
#define MSK_VERSION_REVISION 44
...
#define MSK_CHECK_CONVEXITY_BEGIN MSK_CHECK_CONVEXITY_NONE
#define MSK_CHECK_CONVEXITY_END   (1+MSK_CHECK_CONVEXITY_FULL)
...
enum MSKdparam_enum {
  ...
  MSK_DPAR_OPTIMIZER_MAX_TIME                      = 48,
  MSK_DPAR_PRESOLVE_TOL_ABS_LINDEP                 = 49,
  MSK_DPAR_PRESOLVE_TOL_AIJ                        = 50,
  MSK_DPAR_PRESOLVE_TOL_PRIMAL_INFEAS_PERTURBATION = 51,
  MSK_DPAR_PRESOLVE_TOL_REL_LINDEP                 = 52,
  MSK_DPAR_PRESOLVE_TOL_S                          = 53,
  MSK_DPAR_PRESOLVE_TOL_X                          = 54,
  MSK_DPAR_QCQO_REFORMULATE_REL_DROP_TOL           = 55,
  MSK_DPAR_SEMIDEFINITE_TOL_APPROX                 = 56,
  MSK_DPAR_SIM_LU_TOL_REL_PIV                      = 57,
...
enum MSKiparam_enum {
  ...
  MSK_IPAR_INTPNT_PURIFY                      = 25,
  MSK_IPAR_INTPNT_REGULARIZATION_USE          = 26,
  MSK_IPAR_INTPNT_SCALING                     = 27,
  MSK_IPAR_INTPNT_SOLVE_FORM                  = 28,
  ...
  MSK_IPAR_LOG_CHECK_CONVEXITY                = 39,
  ...
  MSK_IPAR_MIO_CONIC_OUTER_APPROXIMATION      = 61,
  MSK_IPAR_MIO_CONSTRUCT_SOL                  = 62,
  ...
  MSK_IPAR_MIO_MAX_NUM_BRANCHES               = 73,
  MSK_IPAR_MIO_MAX_NUM_RELAXS                 = 74,
  MSK_IPAR_MIO_MAX_NUM_ROOT_CUT_ROUNDS        = 75,
  MSK_IPAR_MIO_MAX_NUM_SOLUTIONS              = 76,
  MSK_IPAR_MIO_MEMORY_EMPHASIS_LEVEL          = 77,
  MSK_IPAR_MIO_MODE                           = 78,
  MSK_IPAR_MIO_NODE_OPTIMIZER                 = 79,
  MSK_IPAR_MIO_NODE_SELECTION                 = 80,
  MSK_IPAR_MIO_NUMERICAL_EMPHASIS_LEVEL       = 81,
  MSK_IPAR_MIO_PERSPECTIVE_REFORMULATE        = 82,
  MSK_IPAR_MIO_PRESOLVE_AGGREGATOR_USE        = 83,
  MSK_IPAR_MIO_PROBING_LEVEL                  = 84,
  MSK_IPAR_MIO_PROPAGATE_OBJECTIVE_CONSTRAINT = 85,
  MSK_IPAR_MIO_QCQO_REFORMULATION_METHOD      = 86,
  MSK_IPAR_MIO_RINS_MAX_NODES                 = 87,
  MSK_IPAR_MIO_ROOT_OPTIMIZER                 = 88,
  MSK_IPAR_MIO_ROOT_REPEAT_PRESOLVE_LEVEL     = 89,
  MSK_IPAR_MIO_SEED                           = 90,
  MSK_IPAR_MIO_SYMMETRY_LEVEL                 = 91,
  MSK_IPAR_MIO_VB_DETECTION_LEVEL             = 92,
  MSK_IPAR_MT_SPINCOUNT                       = 93,
  MSK_IPAR_NG                                 = 94,
  MSK_IPAR_NUM_THREADS                        = 95,
  MSK_IPAR_OPF_WRITE_HEADER                   = 96,
  MSK_IPAR_OPF_WRITE_HINTS                    = 97,
  MSK_IPAR_OPF_WRITE_LINE_LENGTH              = 98,
  MSK_IPAR_OPF_WRITE_PARAMETERS               = 99,
  MSK_IPAR_OPF_WRITE_PROBLEM                  = 100,
  MSK_IPAR_OPF_WRITE_SOL_BAS                  = 101,
  MSK_IPAR_OPF_WRITE_SOL_ITG                  = 102,
  MSK_IPAR_OPF_WRITE_SOL_ITR                  = 103,
  MSK_IPAR_OPF_WRITE_SOLUTIONS                = 104,
  MSK_IPAR_OPTIMIZER                          = 105,
  MSK_IPAR_PARAM_READ_CASE_NAME               = 106,
  MSK_IPAR_PARAM_READ_IGN_ERROR               = 107,
  MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_FILL       = 108,
  MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_NUM_TRIES  = 109,
  MSK_IPAR_PRESOLVE_LEVEL                     = 110,
  MSK_IPAR_PRESOLVE_LINDEP_ABS_WORK_TRH       = 111,
  MSK_IPAR_PRESOLVE_LINDEP_REL_WORK_TRH       = 112,
  MSK_IPAR_PRESOLVE_LINDEP_USE                = 113,
  MSK_IPAR_PRESOLVE_MAX_NUM_PASS              = 114,
  MSK_IPAR_PRESOLVE_MAX_NUM_REDUCTIONS        = 115,
  MSK_IPAR_PRESOLVE_USE                       = 116,
  MSK_IPAR_PRIMAL_REPAIR_OPTIMIZER            = 117,
  MSK_IPAR_PTF_WRITE_PARAMETERS               = 118,
  MSK_IPAR_PTF_WRITE_SOLUTIONS                = 119,
  MSK_IPAR_PTF_WRITE_TRANSFORM                = 120,
  MSK_IPAR_READ_DEBUG                         = 121,
  MSK_IPAR_READ_KEEP_FREE_CON                 = 122,
  MSK_IPAR_READ_MPS_FORMAT                    = 123,
  MSK_IPAR_READ_MPS_WIDTH                     = 124,
  MSK_IPAR_READ_TASK_IGNORE_PARAM             = 125,
  MSK_IPAR_REMOTE_USE_COMPRESSION             = 126,
  MSK_IPAR_REMOVE_UNUSED_SOLUTIONS            = 127,
  MSK_IPAR_SENSITIVITY_ALL                    = 128,
  MSK_IPAR_SENSITIVITY_OPTIMIZER              = 129,
  MSK_IPAR_SENSITIVITY_TYPE                   = 130,
  MSK_IPAR_SIM_BASIS_FACTOR_USE               = 131,
  MSK_IPAR_SIM_DEGEN                          = 132,
  MSK_IPAR_SIM_DETECT_PWL                     = 133,
  MSK_IPAR_SIM_DUAL_CRASH                     = 134,
  MSK_IPAR_SIM_DUAL_PHASEONE_METHOD           = 135,
  MSK_IPAR_SIM_DUAL_RESTRICT_SELECTION        = 136,
  MSK_IPAR_SIM_DUAL_SELECTION                 = 137,
  MSK_IPAR_SIM_EXPLOIT_DUPVEC                 = 138,
  MSK_IPAR_SIM_HOTSTART                       = 139,
  MSK_IPAR_SIM_HOTSTART_LU                    = 140,
  MSK_IPAR_SIM_MAX_ITERATIONS                 = 141,
  MSK_IPAR_SIM_MAX_NUM_SETBACKS               = 142,
  MSK_IPAR_SIM_NON_SINGULAR                   = 143,
  MSK_IPAR_SIM_PRIMAL_CRASH                   = 144,
  MSK_IPAR_SIM_PRIMAL_PHASEONE_METHOD         = 145,
  MSK_IPAR_SIM_PRIMAL_RESTRICT_SELECTION      = 146,
  MSK_IPAR_SIM_PRIMAL_SELECTION               = 147,
  MSK_IPAR_SIM_REFACTOR_FREQ                  = 148,
  MSK_IPAR_SIM_REFORMULATION                  = 149,
  MSK_IPAR_SIM_SAVE_LU                        = 150,
  MSK_IPAR_SIM_SCALING                        = 151,
  MSK_IPAR_SIM_SCALING_METHOD                 = 152,
  MSK_IPAR_SIM_SEED                           = 153,
  MSK_IPAR_SIM_SOLVE_FORM                     = 154,
  MSK_IPAR_SIM_STABILITY_PRIORITY             = 155,
  MSK_IPAR_SIM_SWITCH_OPTIMIZER               = 156,
  MSK_IPAR_SOL_FILTER_KEEP_BASIC              = 157,
  MSK_IPAR_SOL_FILTER_KEEP_RANGED             = 158,
  MSK_IPAR_SOL_READ_NAME_WIDTH                = 159,
  MSK_IPAR_SOL_READ_WIDTH                     = 160,
  MSK_IPAR_SOLUTION_CALLBACK                  = 161,
  MSK_IPAR_TIMING_LEVEL                       = 162,
  MSK_IPAR_WRITE_BAS_CONSTRAINTS              = 163,
  MSK_IPAR_WRITE_BAS_HEAD                     = 164,
  MSK_IPAR_WRITE_BAS_VARIABLES                = 165,
  MSK_IPAR_WRITE_COMPRESSION                  = 166,
  MSK_IPAR_WRITE_DATA_PARAM                   = 167,
  MSK_IPAR_WRITE_FREE_CON                     = 168,
  MSK_IPAR_WRITE_GENERIC_NAMES                = 169,
  MSK_IPAR_WRITE_GENERIC_NAMES_IO             = 170,
  MSK_IPAR_WRITE_IGNORE_INCOMPATIBLE_ITEMS    = 171,
  MSK_IPAR_WRITE_INT_CONSTRAINTS              = 172,
  MSK_IPAR_WRITE_INT_HEAD                     = 173,
  MSK_IPAR_WRITE_INT_VARIABLES                = 174,
  MSK_IPAR_WRITE_JSON_INDENTATION             = 175,
  MSK_IPAR_WRITE_LP_FULL_OBJ                  = 176,
  MSK_IPAR_WRITE_LP_LINE_WIDTH                = 177,
  MSK_IPAR_WRITE_MPS_FORMAT                   = 178,
  MSK_IPAR_WRITE_MPS_INT                      = 179,
  MSK_IPAR_WRITE_SOL_BARVARIABLES             = 180,
  MSK_IPAR_WRITE_SOL_CONSTRAINTS              = 181,
  MSK_IPAR_WRITE_SOL_HEAD                     = 182,
  MSK_IPAR_WRITE_SOL_IGNORE_INVALID_NAMES     = 183,
  MSK_IPAR_WRITE_SOL_VARIABLES                = 184,
  MSK_IPAR_WRITE_TASK_INC_SOL                 = 185,
  MSK_IPAR_WRITE_XML_MODE                     = 186
};
...
#define MSK_STARTING_POINT_END   (1+MSK_STARTING_POINT_SATISFY_BOUNDS)
...
#define MSK_IINF_MIO_NUM_LIPRO_CUTS_                        "MSK_IINF_MIO_NUM_LIPRO_CUTS"
...
typedef enum MSKcheckconvexitytype_enum MSKcheckconvexitytypee;
