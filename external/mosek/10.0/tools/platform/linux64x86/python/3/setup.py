...
class install(setuptools.command.install.install):
    ...
    """
    libdir   = ['../../bin']
    instlibs = ['libtbb.so.12', 'libtbb.so.12.6', 'libmosek64.so.10.0']
...
setup(name =             'Mosek',
      ...
      ext_modules =      [ Extension("mosek._msk",sources=[r"mosek/_msk.abi3.so"]),Extension("mosek.fusion.impl.fragments",sources=[r"mosek/fusion/impl/fragments.abi3.so"]) ],
