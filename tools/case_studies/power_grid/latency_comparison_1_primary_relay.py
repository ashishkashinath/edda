...
# ── Read data ────────────────────────────────────────────────────
df = pd.read_csv('latency_results_1_primary_relay.csv')
...
# ── Axes labels & ticks ──────────────────────────────────────────
ax.set_xlabel("Primary Relay", fontsize=28)
...
plt.tight_layout()
plt.savefig("latency_comparison_1_primary_relay.pdf", dpi=300, bbox_inches="tight")