...
# ── Read data ────────────────────────────────────────────────────
df = pd.read_csv('latency_results_5_ea_client.csv')
...
# ── Axes labels & ticks ──────────────────────────────────────────
ax.set_xlabel("EA Client", fontsize=28)
ax.set_ylabel("Worst-case Delay (ms)", fontsize=28)
#ax.set_xticks(x)
#ax.set_xticklabels(categories, fontsize=28)
ax.set_xticklabels([])
ax.tick_params(axis='y', labelsize=28)
ax.legend(fontsize=20, ncol=2, loc='upper left', bbox_to_anchor=(0.01, 1.06), frameon=True)
...
plt.tight_layout()
plt.savefig("latency_results_5_ea_client.pdf", dpi=300, bbox_inches="tight")